...
/* 17 */     final List<Suggestion> suggestions = Arrays.<String>stream(strings).map(Suggestion::suggestion).toList();
/* 18 */     return new SuggestionProvider<Sender>()
/*    */       {
...
/* Location:              C:\Users\Cameron Crenshaw\Downloads\grimac-bukkit-2.3.72.jar!\ac\grim\grimac\command\CommandUtils.class
