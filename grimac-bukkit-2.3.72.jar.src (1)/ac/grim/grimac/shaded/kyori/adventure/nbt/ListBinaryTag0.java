...
/* 275 */       BinaryTag potentialValue = compound.get("");
...
/* 283 */     if (needsBox(tag)) {
/* 284 */       return new CompoundBinaryTagImpl(Collections.singletonMap("", tag));
/*     */     }
/* 286 */     return (CompoundBinaryTag)tag;
/*     */   }
/*     */ 
/*     */   
/*     */   private static boolean needsBox(BinaryTag tag) {
/* 291 */     if (!(tag instanceof CompoundBinaryTag)) {
/* 292 */       return true;
/*     */     }
/*     */     
/* 295 */     CompoundBinaryTag compound = (CompoundBinaryTag)tag;
/* 296 */     return (compound.size() == 1 && compound.get("") != null);
/*     */   }
/*     */ }


/* Location:              C:\Users\Cameron Crenshaw\Downloads\grimac-bukkit-2.3.72.jar!\ac\grim\grimac\shaded\kyori\adventure\nbt\ListBinaryTag0.class
