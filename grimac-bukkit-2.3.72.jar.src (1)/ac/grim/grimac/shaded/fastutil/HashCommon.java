...
/* 188 */     return Math.min((int)Math.ceil(n * f), n - 1);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 204 */     return Math.min((long)Math.ceil(n * f), n - 1L);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 219 */     long s = Math.max(2L, nextPowerOfTwo((long)Math.ceil(expected / f)));
/* 220 */     if (s > 1073741824L) throw new IllegalArgumentException("Too large (" + expected + " expected elements with load factor " + f + ")"); 
/* 221 */     return (int)s;
/*     */   }
/*     */ 
/*     */ 
...
/* 235 */     return nextPowerOfTwo((long)Math.ceil(expected / f));
/*     */   }
/*     */ }


/* Location:              C:\Users\Cameron Crenshaw\Downloads\grimac-bukkit-2.3.72.jar!\ac\grim\grimac\shaded\fastutil\HashCommon.class
