...
/*   56 */   private static final long SOFT_TIMEOUT_FLOOR = Long.getLong("ac.grim.grimac.shaded.zaxxer.hikari.timeoutMs.floor", 250L).longValue();
...
/* 1167 */         String next = String.valueOf(Integer.getInteger("ac.grim.grimac.shaded.zaxxer.hikari.pool_number", 0).intValue() + 1);
/* 1168 */         System.setProperty("ac.grim.grimac.shaded.zaxxer.hikari.pool_number", next);
...
/* Location:              C:\Users\Cameron Crenshaw\Downloads\grimac-bukkit-2.3.72.jar!\ac\grim\grimac\shaded\zaxxer\hikari\HikariConfig.class
