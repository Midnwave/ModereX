...
/*     */ import ac.grim.grimac.shaded.zaxxer.hikari.pool.HikariPool;
...
/* 113 */             seal();
/*     */           }
/* 115 */           catch (ac.grim.grimac.shaded.zaxxer.hikari.pool.HikariPool.PoolInitializationException pie) {
...
/*     */     HikariPool p;
/* 332 */     if (!isClosed() && (p = this.pool) != null && connection.getClass().getName().startsWith("ac.grim.grimac.shaded.zaxxer.hikari")) {
...
/* Location:              C:\Users\Cameron Crenshaw\Downloads\grimac-bukkit-2.3.72.jar!\ac\grim\grimac\shaded\zaxxer\hikari\HikariDataSource.class
