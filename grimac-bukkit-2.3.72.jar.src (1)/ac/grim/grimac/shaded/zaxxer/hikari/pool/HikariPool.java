...
/*     */ import ac.grim.grimac.shaded.zaxxer.hikari.HikariPoolMXBean;
...
/*     */ import ac.grim.grimac.shaded.zaxxer.hikari.metrics.dropwizard.CodahaleHealthChecker;
/*     */ import ac.grim.grimac.shaded.zaxxer.hikari.metrics.dropwizard.CodahaleMetricsTrackerFactory;
/*     */ import ac.grim.grimac.shaded.zaxxer.hikari.metrics.micrometer.MicrometerMetricsTrackerFactory;
/*     */ import ac.grim.grimac.shaded.zaxxer.hikari.util.ClockSource;
/*     */ import ac.grim.grimac.shaded.zaxxer.hikari.util.ConcurrentBag;
/*     */ import ac.grim.grimac.shaded.zaxxer.hikari.util.SuspendResumeLock;
/*     */ import ac.grim.grimac.shaded.zaxxer.hikari.util.UtilityElf;
...
/*  81 */   private final long aliveBypassWindowMs = Long.getLong("ac.grim.grimac.shaded.zaxxer.hikari.aliveBypassWindowMs", TimeUnit.MILLISECONDS.toMillis(500L)).longValue();
/*  82 */   private final long housekeepingPeriodMs = Long.getLong("ac.grim.grimac.shaded.zaxxer.hikari.housekeeping.periodMs", TimeUnit.SECONDS.toMillis(30L)).longValue();
/*     */   
...
/*     */     
/* 140 */     if (Boolean.getBoolean("ac.grim.grimac.shaded.zaxxer.hikari.blockUntilFilled") && config.getInitializationFailTimeout() > 1L) {
...
/* Location:              C:\Users\Cameron Crenshaw\Downloads\grimac-bukkit-2.3.72.jar!\ac\grim\grimac\shaded\zaxxer\hikari\pool\HikariPool.class
