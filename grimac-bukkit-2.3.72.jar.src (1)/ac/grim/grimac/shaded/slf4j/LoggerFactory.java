...
/*     */ import ac.grim.grimac.shaded.slf4j.helpers.NOPLoggerFactory;
/*     */ import ac.grim.grimac.shaded.slf4j.helpers.SubstituteLogger;
/*     */ import ac.grim.grimac.shaded.slf4j.helpers.SubstituteLoggerFactory;
/*     */ import ac.grim.grimac.shaded.slf4j.helpers.Util;
/*     */ import ac.grim.grimac.shaded.slf4j.impl.StaticLoggerBinder;
...
/* 131 */     if (msg == null)
/* 132 */       return false; 
/* 133 */     if (msg.contains("ac/grim/grimac/shaded/slf4j/impl/StaticLoggerBinder"))
/* 134 */       return true; 
/* 135 */     if (msg.contains("ac.grim.grimac.shaded.slf4j.impl.StaticLoggerBinder"))
/* 136 */       return true; 
/* 137 */     return false;
/*     */   }
/*     */   
...
/* 166 */       if (msg != null && msg.contains("ac.grim.grimac.shaded.slf4j.impl.StaticLoggerBinder.getSingleton()")) {
...
/*     */ 
/*     */   
/* 295 */   private static String STATIC_LOGGER_BINDER_PATH = "ac/grim/grimac/shaded/slf4j/impl/StaticLoggerBinder.class";
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/* Location:              C:\Users\Cameron Crenshaw\Downloads\grimac-bukkit-2.3.72.jar!\ac\grim\grimac\shaded\slf4j\LoggerFactory.class
