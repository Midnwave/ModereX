    ...
    private boolean isTypeEnabled(ActivityType type) {
        return switch (type) {
            ...
            case STAFF_PUNISHMENT, STAFF_PARDON,
                 ...
                 STAFF_AUTOMOD_UPDATE, STAFF_CLEAR_CHAT, STAFF_KICK_ALL,
                 // New staff audit log types
                 STAFF_AUTOMOD_CREATE, STAFF_AUTOMOD_DELETE,
                 STAFF_TEMPLATE_CREATE, STAFF_TEMPLATE_UPDATE, STAFF_TEMPLATE_DELETE,
                 STAFF_CONFIG_MUTE, STAFF_CONFIG_WARN, STAFF_CONFIG_ANTICHEAT,
                 STAFF_CONFIG_ACTIVITYLOG, STAFF_CONFIG_EVIDENCE,
                 STAFF_RANK_CREATE, STAFF_RANK_DELETE, STAFF_RANK_EDIT,
                 STAFF_PERMISSION_GRANT, STAFF_PERMISSION_REVOKE,
                 STAFF_LUCKPERMS_SYNC,
                 STAFF_WEBPANEL_PUNISHMENT, STAFF_WEBPANEL_PARDON, STAFF_WEBPANEL_CONFIG,
                 STAFF_WEBPANEL_WATCHLIST, STAFF_WEBPANEL_CMDBLACKLIST -> true;
        };
    }
